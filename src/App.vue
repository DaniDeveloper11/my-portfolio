<template>
  <div class="bg-gray-900">
    <header class="fixed inset-x-0 top-0 z-50 bg-gray-900">
      <nav class="flex items-center place-content-between px-6 py-0 lg:px-8 " aria-label="Global">
        <div class="flex lg:flex-1 lg:w-2/5">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">My Portfolio</span>
            <img class="h-20 w-auto" src="./assets/portafolio.png" alt="logo" />
          </a>
        </div>
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
          <div class="flex items-center justify-between">
            <a href="#" class="-m-1.5 p-1.5">
              ...
              <img class="h-20 w-auto" src="./assets/portafolio.png " alt="" />
            </a>
